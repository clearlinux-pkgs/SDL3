...
Source0  : https://github.com/libsdl-org/SDL/releases/download/release-3.2.18/SDL3-3.2.18.tar.gz
Source1  : https://github.com/libsdl-org/SDL/releases/download/release-3.2.18/SDL3-3.2.18.tar.gz.sig
...
%setup -q -n SDL3-3.2.18
cd %{_builddir}/SDL3-3.2.18
pushd ..
cp -a SDL3-3.2.18 buildavx2
popd
pushd ..
cp -a SDL3-3.2.18 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752587700
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSDL3.so.0.2.18
/VA/usr/lib64/libSDL3.so.0.2.18
/usr/lib64/libSDL3.so.0
/usr/lib64/libSDL3.so.0.2.18
