...
Source0  : https://github.com/libsdl-org/SDL/releases/download/release-3.2.12/SDL3-3.2.12.tar.gz
Source1  : https://github.com/libsdl-org/SDL/releases/download/release-3.2.12/SDL3-3.2.12.tar.gz.sig
...
%setup -q -n SDL3-3.2.12
cd %{_builddir}/SDL3-3.2.12
pushd ..
cp -a SDL3-3.2.12 buildavx2
popd
pushd ..
cp -a SDL3-3.2.12 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746458018
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSDL3.so.0.2.12
/VA/usr/lib64/libSDL3.so.0.2.12
/usr/lib64/libSDL3.so.0
/usr/lib64/libSDL3.so.0.2.12
